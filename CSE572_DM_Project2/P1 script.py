...
CGMSeriesLunchPatient1=pandas.read_csv('DataFolder/CGMSeriesLunchPat1.csv')
CGMSeriesLunchPatient1.replace(to_replace = np.nan, value = CGMSeriesLunchPatient1.mean(), inplace= True)
